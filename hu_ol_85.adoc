...
---
= Verwendung von Oracle Linux 8.5 mit NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
...
NOTE: Um Oracle Linux 8.5 RedHat Enterprise Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_85.html#recommended-settings["Empfohlene Einstellungen"] Für Red hat Enterprise Linux (RHEL) 8.5.
...
Es gibt keine bekannten Probleme für Oracle Linux 8.5.
