...
NOTE: Um Oracle Linux 8.5 Red hat Enterprise Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_85.html#recommended-settings["Empfohlene Einstellungen"] für Red hat Enterprise Linux (RHEL) 8.5.
...
Es gibt keine bekannten Probleme für die Oracle Linux 8.5 mit ONTAP-Version.


NOTE: Informationen zu bekannten Problemen mit Oracle Linux (Red hat kompatibler Kernel) finden Sie im link:hu_rhel_85.html#known-problems-and-limitations["Bekannte Probleme"] Abschnitt in der entsprechenden Red hat Enterprise Linux Release-Dokumentation.
