...
summary: Installieren Sie Linux Host Utilities auf einem Oracle Linux 8.5-Host, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu verwalten. 
---
= Konfigurieren Sie Oracle Linux 8.5 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit Oracle Linux 8.5 verwenden, um ONTAP-LUNs zu verwalten.


NOTE: Sie können die link:hu_rhel_85.html#rhel-rhck["empfohlene Einstellungen für Red Hat Enterprise Linux (RHEL) 8.5"] um den Red Hat Compatible Kernel für Oracle Linux 8.5 zu konfigurieren.
...
NOTE: Informationen zu bekannten Oracle Linux RHCK-Problemen finden Sie im link:hu_rhel_85.html#known-problems-and-limitations["Bekannte Probleme"] Abschnitt in der entsprechenden Dokumentation zur Red hat Enterprise Linux-Version.
