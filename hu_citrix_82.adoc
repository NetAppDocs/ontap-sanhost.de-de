...
summary: Konfigurieren Sie Citrix Hypervisor 8.2 für Multipathing und mit spezifischen Parametern und Einstellungen für FCP- und iSCSI-Protokollvorgänge mit ONTAP Speicher. 
---
= Konfigurieren Sie Citrix Hypervisor 8.2 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Konfigurieren Sie Citrix Hypervisor 8.2 für Multipathing und mit spezifischen Parametern und Einstellungen für FCP- und iSCSI-Protokollvorgänge mit ONTAP Speicher.
...
Sie können Multipathing mit Citrix Hypervisor 8.2 verwenden, um ONTAP LUNs zu verwalten.
