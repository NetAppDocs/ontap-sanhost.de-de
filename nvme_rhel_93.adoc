...
--
.Schritte
. Der native Inbox qla2xxx Treiber, der im RHEL 9.3 GA Kernel enthalten ist, hat die neuesten Fixes, die für die Unterstützung von ONTAP unerlässlich sind. Vergewissern Sie sich, dass der unterstützte Adaptertreiber und die unterstützten Firmware-Versionen ausgeführt werden:
+
[listing]
----
