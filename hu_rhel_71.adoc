...
---
= Konfigurieren Sie RHEL 7.1 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit RHEL 7.1 zum Verwalten von ONTAP-LUNs verwenden.
...
Die RHEL 7.1 mit ONTAP-Speicherversion weist folgende bekannte Probleme auf:
