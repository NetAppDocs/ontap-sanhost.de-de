...
. Das Softwarepaket „NetApp Linux Host Utilities“ ist auf der NetApp -Support-Site in einer 64-Bit-RPM-Datei verfügbar.  Laden Sie die 64-Bit-Datei von derlink:https://mysupport.netapp.com/site/products/all/details/hostutilities/downloads-tab/download/61343/7.1/downloads["NetApp Support Website"^] an Ihren Gastgeber.
