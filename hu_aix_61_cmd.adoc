...
summary: Sie können die Beispielbefehlreferenz für die AIX Host Utilities für eine End-to-End-Validierung der NetApp-Speicherkonfiguration mit dem Host Utilities-Tool verwenden. 
---
...
[role="lead"]
Sie können die Beispielbefehlreferenz für die AIX Host Utilities für eine End-to-End-Validierung der NetApp-Speicherkonfiguration mit dem Host Utilities-Tool verwenden.
