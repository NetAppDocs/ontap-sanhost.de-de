...
[role="lead"]
Sie können die AIX Host Utilities 6.1-Befehlsreferenz für eine End-to-End-Validierung der NetApp-Speicherkonfiguration mithilfe des Host Utilities-Tools verwenden.
