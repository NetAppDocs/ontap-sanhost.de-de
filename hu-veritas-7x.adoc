...
---
= Konfigurieren Sie Veritas Infoscale 7 für FC, FCoE und iSCSI mit ONTAP -Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Verwenden Sie Veritas Dynamic Multipathing (VxDMP) mit Veritas Infoscale 7 zur Verwaltung von ONTAP LUNs.
