...
Sie müssen überprüfen, ob Ihre Konfiguration den Systemanforderungen entspricht. Weitere Informationen finden Sie in https://imt.netapp.com/matrix/#welcome["Interoperabilitäts-Matrix-Tool"^] der und der Veritas HCL Matrix.
