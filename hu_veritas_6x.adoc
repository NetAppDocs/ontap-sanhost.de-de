...
Sie müssen überprüfen, ob Ihre Konfiguration den Systemanforderungen entspricht. Weitere Informationen finden Sie im https://["NetApp Interoperabilitäts-Matrix-Tool"^] Und die Veritas HCL Matrix.
