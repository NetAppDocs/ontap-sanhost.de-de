...
--
.Schritte
. Der native Inbox qla2xxx Treiber, der im OL 9.3 GA Kernel enthalten ist, verfügt über die neuesten Upstream-Fixes, die für die Unterstützung von ONTAP unerlässlich sind. Vergewissern Sie sich, dass der unterstützte Adaptertreiber und die unterstützten Firmware-Versionen ausgeführt werden:
+
[listing]
----
