---
sidebar: sidebar 
permalink: nvme-rockylinux-9x.html 
keywords: nvme, rocky, red hat, enterprise 
summary: Konfiguration eines NVMe-oF-Hosts für Rocky Linux 9.x mit ONTAP 
---
= Rocky Linux 9.x für NVMe-oF mit ONTAP -Speicher konfigurieren
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Erfahren Sie, wie Sie NVMe over Fabrics (NVMe-oF)-Hosts für Rocky Linux 9.x konfigurieren. Weitere Informationen zu Support und Funktionen finden Sie unter link:nvme-rockylinux-supported-features.html["Rocky Linux ONTAP Unterstützung und Funktionen"]Die

NVMe-oF unter Rocky Linux 9.x weist folgende bekannte Einschränkungen auf:
...
.Schritte
. Installieren Sie Rocky Linux 9.x auf dem Server.  Nach Abschluss der Installation überprüfen Sie, ob Sie den erforderlichen Rocky Linux 9.x-Kernel verwenden:
+
[source, cli]
----
uname -r
...
.NVMe/TCP
--
Das NVMe/TCP-Protokoll unterstützt den automatischen Verbindungsvorgang nicht.  Sie müssen die NVMe/TCP-Verbindungs- oder -Allesverbindungsvorgänge manuell durchführen, um die NVMe/TCP-Subsysteme und -Namespaces zu ermitteln.
...
Eine sichere In-Band-Authentifizierung wird über NVMe/TCP zwischen einem Rocky Linux 9x-Host und einem ONTAP Controller unterstützt.
...
cat /etc/nvme/hostnqn
----
. Generieren Sie den DHCP-Schlüssel für den Rocky Linux 9.x-Host.
+
...
[
{
  "hostnqn":"nqn.2014-08.org.nvmexpress:uuid:9796xxxx-0d34-xxxx-
  b6b2-3a6xxxxbab57",
  "hostid":"b033cd4fd6db4724adb48655bfb55448",
  "dhchap_key":" DHHC-1:01:CNxTYq73T9vJk0JpOfDBZrhDCqpWBN4XVZI5WxwPgDUieHAi:"
},
{
  "hostnqn":"nqn.2014-08.org.nvmexpress:uuid:4c4cxxxx-0035-xxxx-
  804b-b5cxxxx44d33",
  "subsystems":[
        {
          "nqn":"nqn.1992-
...
[listing]
----
already connected to hostnqn=nqn.2014-08.org.nvmexpress:uuid:4c4cxxxx-0035-xxxx-804b-b5cxxxx44d33,nqn=nqn.1992-08.com.netapp:sn.8dde3be2cc7c11efb777d039eab6cb6d:subsystem. bidi
