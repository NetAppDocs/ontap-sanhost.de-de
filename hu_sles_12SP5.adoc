...
summary: Installieren Sie die Linux Host Utilities auf einem SUSE Linux Enterprise Server 12 SP5, um FCP- und iSCSI-Protokollvorgänge mit ONTAP-LUNs zu verwalten. 
---
