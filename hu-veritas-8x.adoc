...
summary: Verwenden Sie Linux Host Utilities mit Veritas Infoscale 8 für RHEL- und Oracle Linux-Hosts, um FC-, FCoE- und iSCSI-Protokolloperationen mit ONTAP LUNs zu verwalten. 
---
= Konfigurieren Sie Veritas Infoscale 8 für FC, FCoE und iSCSI mit ONTAP -Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Verwenden Sie Veritas Dynamic Multipathing (VxDMP) mit Veritas Infoscale 8 zur Verwaltung von ONTAP LUNs.
