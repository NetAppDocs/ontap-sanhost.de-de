...
keywords: host utilities, linux, 20.04, netapp, ontap, ubuntu 
summary: Konfigurieren Sie Ubuntu 20.04 für Multipathing und mit spezifischen Parametern und Einstellungen für FCP- und iSCSI-Protokollvorgänge mit ONTAP Speicher. 
---
= Konfigurieren Sie Ubuntu 20.04 für FCP und iSCSI mit ONTAP -Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Konfigurieren Sie Ubuntu 20.04 für Multipathing und mit spezifischen Parametern und Einstellungen für FCP- und iSCSI-Protokollvorgänge mit ONTAP Speicher.
...
Sie können Multipathing mit Ubuntu 20.04 verwenden, um ONTAP -LUNs zu verwalten.
