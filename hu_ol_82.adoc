...
---
= Verwendung von Oracle Linux 8.2 mit NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
...
NOTE: Um Oracle Linux 8.2 RedHat Enterprise Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_82.html#recommended-settings["Empfohlene Einstellungen"] Für Red hat Enterprise Linux (RHEL) 8.2.



== Bekannte Probleme und Einschränkungen

Es gibt keine bekannten Probleme für Oracle Linux 8.2.
