...
NOTE: Um Oracle Linux 9.4 Red hat Enterprise Kernel (RHEK) zu konfigurieren, verwenden Sie den link:hu_rhel_94.html#recommended-settings["Empfohlene Einstellungen"] für Red hat Enterprise Linux (RHEL) 9.4.
