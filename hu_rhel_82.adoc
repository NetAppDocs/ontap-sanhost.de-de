...
---
= Einsatz von Red hat Enterprise Linux 8.2 mit NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Für Red hat Enterprise Linux (RHEL) 8.2 muss die Datei /etc/Multipath.conf vorhanden sein, Sie müssen jedoch keine spezifischen Änderungen an der Datei vornehmen. RHEL 8.2 wird mit allen Einstellungen zusammengestellt, die zum Erkennen und korrekten Managen von ONTAP-LUNs erforderlich sind.
...
Es gibt keine bekannten Probleme für RHEL 8.2.
