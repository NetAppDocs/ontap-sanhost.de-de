...
summary: Installieren Sie Linux Host Utilities auf einem Oracle Linux 9.1-Host, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu verwalten. 
---
...
NOTE: Sie können die link:hu_rhel_91.html#rhel-rhck["empfohlene Einstellungen für Red Hat Enterprise Linux (RHEL) 9.1"] um den Red Hat Compatible Kernel für Oracle Linux 9.1 zu konfigurieren.
