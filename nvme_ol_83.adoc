...
Siehe http://mysupport.netapp.com/matrix3["NetApp Interoperabilitäts-Matrix-Tool (IMT)"^] In der aktuellen Liste der unterstützten Konfigurationen.
...
.Schritte
. Installieren Sie Oracle Linux 8.3 GA auf dem Server. Überprüfen Sie nach Abschluss der Installation, ob Sie den angegebenen Oracle Linux 8.3 GA-Kernel ausführen. Siehe https://mysupport.netapp.com/matrix/["NetApp Interoperabilitäts-Matrix-Tool"^] Erhalten Sie auf der aktuellen Liste der unterstützten Versionen.
+
[listing]
----
# uname -r
...
.Schritte
. Vergewissern Sie sich, dass Sie den unterstützten Adapter verwenden. Die aktuelle Liste der unterstützten Adapter finden Sie im https://mysupport.netapp.com/matrix/["NetApp Interoperabilitäts-Matrix-Tool"^].
+
[listing]
----
...
Emulex LPe36002-M64 2-Port 64Gb Fibre Channel Adapter
----
. Überprüfen Sie, ob Sie die empfohlene Broadcom lpfc-Firmware und den Posteingangstreiber verwenden. Die aktuelle Liste der unterstützten Adaptertreiber und Firmware-Versionen finden Sie im https://mysupport.netapp.com/matrix/["NetApp Interoperabilitäts-Matrix-Tool"^].
+
[listing]
----
...
Die NVMe-of-Hostkonfiguration für OL 8.3 mit ONTAP-Release hat die folgenden bekannten Probleme:
