...
---
= Verwenden Sie Red hat Enterprise Linux 7.8 mit ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Sie können die Konfigurationseinstellungen des ONTAP-SAN-Hosts verwenden, um Red hat Enterprise Linux 7.8 mit ONTAP als Ziel zu konfigurieren.
...
Die RHEL 7.8 mit ONTAP-Version weist folgende bekannte Probleme auf:
