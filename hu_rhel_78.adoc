...
---
= Konfigurieren Sie RHEL 7.8 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit RHEL 7.8 zum Verwalten von ONTAP-LUNs verwenden.
...
Das RHEL 7.8 mit ONTAP-Speicherversion weist das folgende bekannte Problem auf:
