---
sidebar: sidebar 
permalink: hu-rhel-10x.html 
keywords: host utilities, red hat, rhel, linux, 10.x, netapp, ontap, rhel 
summary: Installieren Sie Linux Host Utilities auf einem RHEL 10.x-Host, um FCP- und iSCSI-Protokolloperationen mit ONTAP LUNs zu verwalten. 
---
= Konfigurieren Sie RHEL 10.x für FCP und iSCSI mit ONTAP -Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Mit RHEL 10.x können Sie Multipathing zur Verwaltung von ONTAP LUNs nutzen.
