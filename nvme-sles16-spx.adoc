...
.NVMe/FC
--
Die folgenden Beispielausgaben zeigen einen Namespace, der auf einem Zwei-Knoten ONTAP Controller für AFF, FAS, ASA oder ASA r2 System mit NVMe/FC gehostet wird.
...
.NVMe/TCP
--
Die folgenden Beispielausgaben zeigen einen Namespace, der auf einem Zwei-Knoten ONTAP Controller für AFF, FAS, ASA oder ASA r2 Systeme mit NVMe/TCP gehostet wird.
...
----
====
.. Exportieren Sie den TLS PSK aus dem Kernel-Keyring. Dies stellt sicher, dass der Schlüssel während eines Host-Neustarts erhalten bleibt:
+
[source, cli]
----
