...
Bekannte Probleme mit CentOS (Red hat Compatible Kernel) finden Sie im Abschnitt link:hu_rhel_80.html#known-problems-and-limitations["Bekannte Probleme"] für Red hat Enterprise Linux (RHEL) 8.0.
