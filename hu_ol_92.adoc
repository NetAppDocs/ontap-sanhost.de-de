...
[role="lead"]
Sie können die Konfigurationseinstellungen des ONTAP-SAN-Hosts verwenden, um Oracle Linux 9.2 mit ONTAP als Ziel zu konfigurieren.
...
NOTE: Um Oracle Linux 9.2 Red hat Enterprise Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_92.html#recommended-settings["Empfohlene Einstellungen"] für Red hat Enterprise Linux (RHEL) 9.2.
...
Die Oracle Linux 9.2 mit ONTAP-Version weist folgende bekannte Probleme auf:
