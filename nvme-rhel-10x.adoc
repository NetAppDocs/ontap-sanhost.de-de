...
In RHEL 10.0 ist die Standard-iopolicy round-robin, aber queue-depth ist als konfigurierbare Option verfügbar. Wenn RHEL 10.0 verwendet wird, kann die iopolicy durch Ändern der udev-Regeldatei auf queue-depth geändert werden.
