...
Folgende Schritte können zum Aktivieren von NVMe-Services durchgeführt werden.
...
Sie können die JSON-Datei mit erstellen `-o` Option. Siehe link:https://docs.netapp.com/us-en/ontap/concepts/manual-pages.html["ONTAP-man-Pages"^] Weitere Syntaxoptionen.
