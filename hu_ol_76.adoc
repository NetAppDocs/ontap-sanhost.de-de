...
summary: Installieren Sie Linux Host Utilities auf einem Oracle Linux 7.6-Host, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu verwalten. 
---
...
NOTE: Sie können die link:hu_rhel_76.html#rhel-rhck["empfohlene Einstellungen für Red Hat Enterprise Linux (RHEL) 7.6"] um den Red Hat Compatible Kernel für Oracle Linux 7.6 zu konfigurieren.
