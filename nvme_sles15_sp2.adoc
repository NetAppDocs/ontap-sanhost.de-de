...
== NVMe/FC auf SLES15 SP2 aktivieren

. Upgrade auf die empfohlene ME-Kernel-Version von SLES15 SP2.
...
----
. Überprüfen Sie auf dem SLES15 SP2-Host die NQN-Zeichenfolge des Hosts bei `/etc/nvme/hostnqn` Und überprüfen Sie, ob es mit der NQN-Zeichenfolge des Hosts für das entsprechende Subsystem auf dem ONTAP-Array übereinstimmt. Beispiel:
+
[listing]
----
