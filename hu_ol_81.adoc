...
NOTE: Informationen zu bekannten Problemen bei Oracle Linux (Red hat Compatible Kernel) finden Sie im Abschnitt link:hu_rhel_81.html#known-problems-and-limitations["Bekannte Probleme"] für Red hat Enterprise Linux (RHEL) 8.1.
