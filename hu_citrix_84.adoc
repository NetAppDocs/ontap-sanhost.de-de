...
summary: Konfigurieren Sie Citrix Hypervisor 8.4 für Multipathing und mit spezifischen Parametern und Einstellungen für FCP- und iSCSI-Protokollvorgänge mit ONTAP Speicher. 
---
