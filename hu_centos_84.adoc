...
[role="lead"]
Sie können die Konfigurationseinstellungen des ONTAP-SAN-Hosts verwenden, um CentOS 8.4 mit ONTAP als Ziel zu konfigurieren.
...
Es gibt keine bekannten Probleme für CentOS 8.4 mit ONTAP-Version.
