...
summary: Konfiguration eines NVMe-oF-Hosts für Rocky Linux 10.x mit ONTAP Speicher 
---
= Rocky Linux 10.x für NVMe-oF mit ONTAP -Speicher konfigurieren
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Erfahren Sie, wie Sie NVMe over Fabrics (NVMe-oF)-Hosts für Rocky Linux 10.x konfigurieren. Weitere Informationen zu Support und Funktionen finden Sie unter link:nvme-rockylinux-supported-features.html["Rocky Linux ONTAP Unterstützung und Funktionen"]Die

NVMe-oF unter Rocky Linux 10.x weist folgende bekannte Einschränkungen auf:
...
== Schritt 2: Installieren Sie Rocky Linux und die NVMe-Software und überprüfen Sie Ihre Konfiguration.
...
.Schritte
. Installieren Sie Rocky Linux 10.x auf dem Server.  Nach Abschluss der Installation überprüfen Sie, ob Sie den erforderlichen Rocky Linux 10.x-Kernel verwenden:
+
[source, cli]
----
uname -r
...
nvme-subsys5 - NQN=nqn.1992-08.com.netapp:sn.f7565b15a66911ef9668d039ea951c46:subsystem.nvme1
               hostnqn=nqn.2014-08.org.nvmexpress:uuid:4c4cxxxx-0056-xxxx-8048-c7cxxxx25633
\
...
nvme-subsys4 - NQN=nqn.1992-08.com.netapp:sn.64e65e6caae711ef9668d039ea951c46:subsystem.nvme4
               hostnqn=nqn.2014-08.org.nvmexpress:uuid:4c4cxxxx-0035-xxxx-804b-c2cxxxx44d33
\
...
Eine sichere In-Band-Authentifizierung wird über NVMe/TCP zwischen einem Rocky Linux 10.x-Host und einem ONTAP Controller unterstützt.
...
cat /etc/nvme/hostnqn
----
. Generieren Sie den DHCP-Schlüssel für den Rocky Linux 10.x-Host.
+
...
[listing]
----
nvme gen-dhchap-key -m 3 -n nqn.2014-08.org.nvmexpress:uuid:4c4cxxxx-0035-xxxx-804b-c2cxxxx44d33
...
[
  {
    "hostnqn":"nqn.2014-08.org.nvmexpress:uuid:4c4cxxxx-0035-xxxx-804b-c2cxxxx44d33",
    "hostid":"4c4cxxxx-0035-xxxx-804b-c2cxxxx44d33",
