...
NOTE: Um Oracle Linux 8.9 RedHat Enterprise Kernel link:hu_rhel_88.html#recommended-settings["Empfohlene Einstellungen"]zu konfigurieren, verwenden Sie den  für Red hat Enterprise Linux (RHEL) 8.9.
