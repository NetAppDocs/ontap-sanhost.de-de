...
.Bevor Sie beginnen
Ihre Konfiguration unterstützt das Booten von SAN. link:https://imt.netapp.com/matrix/#welcome["Interoperabilitäts-Matrix-Tool"^]Überprüfen Sie im, ob Betriebssystem, HBA, HBA-Firmware und HBA-Boot-BIOS sowie ONTAP-Version unterstützt werden.
