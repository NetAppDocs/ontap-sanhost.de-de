...
.Schritte
. Installieren Sie RHEL 8.6 auf dem Server. Überprüfen Sie nach Abschluss der Installation, ob Sie den angegebenen RHEL 8.6-Kernel ausführen. Die aktuelle Liste der unterstützten Versionen finden Sie imlink:https://mysupport.netapp.com/matrix/["Interoperabilitäts-Matrix-Tool"^].
. Überprüfen Sie nach Abschluss der Installation, ob Sie den angegebenen RHEL 8.6-Kernel ausführen. Die aktuelle Liste der unterstützten Versionen finden Sie imlink:https://mysupport.netapp.com/matrix/["Interoperabilitäts-Matrix-Tool"^].
+
Beispiel:
