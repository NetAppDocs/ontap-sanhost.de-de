...
Um bequem über ONTAP-Failover-Ereignisse wie SFOs zu Ebbe zu machen, wird empfohlen, einen längeren Wiederholungszeitraum in etwa 30 Minuten einzustellen, indem die eingestellt wird `ctrl_loss_tmo` Timer. Im Folgenden sind die Details aufgeführt:
