...
.Marvell/QLogic
--
Im nativen Posteingang `qla2xxx` Der im RHEL 8.5 GA-Kernel enthaltene Treiber verfügt über die neuesten Fehlerbehebungen, die für die ONTAP-Unterstützung unerlässlich sind.
