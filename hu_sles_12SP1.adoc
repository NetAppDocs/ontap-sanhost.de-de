...
Das Betriebssystem SUSE Linux Enterprise Server 12 SP1 wird kompiliert, um ONTAP-LUNs zu erkennen und automatisch alle Konfigurationsparameter korrekt einzustellen.
