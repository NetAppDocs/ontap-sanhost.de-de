...
---
= Verwenden Sie SUSE Linux Enterprise Server 15 SP2 mit ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Sie können die Konfigurationseinstellungen des ONTAP-SAN-Hosts verwenden, um SUSE Linux Enterprise Server 15 SP2 mit ONTAP als Ziel zu konfigurieren.
...
Die Version SUSE Linux Enterprise Server 15 SP2 mit ONTAP weist folgende bekannte Probleme auf:
