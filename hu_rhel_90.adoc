...
keywords: host utilities, red hat, rhel, linux, 9.0, netapp, ontap 
summary: Installieren Sie die Linux Host Utilities auf einem RHEL 9.0 Host, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu managen. 
---
= Konfigurieren Sie RHEL 9.0 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit RHEL 9.0 zum Verwalten von ONTAP-LUNs verwenden.
