...
---
= Verwenden Sie Red hat Enterprise Linux 9.0 mit ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Sie können die Konfigurationseinstellungen des ONTAP-SAN-Hosts verwenden, um Red hat Enterprise Linux 9.0 mit ONTAP als Ziel zu konfigurieren.
...
Es gibt keine bekannten Probleme für RHEL 9.0 mit ONTAP-Version.
