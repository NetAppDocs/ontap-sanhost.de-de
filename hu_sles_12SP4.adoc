...
Das Betriebssystem SUSE Linux Enterprise Server 12 SP4 wird kompiliert, um ONTAP-LUNs zu erkennen und automatisch alle Konfigurationsparameter richtig einzustellen.
