...
Sie müssen keine Einstellungen für eine Kernel-basierte virtuelle Maschine unter Oracle Linux 8.10 konfigurieren, da die LUN dem Hypervisor zugeordnet ist.
