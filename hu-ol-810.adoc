...
---
= Konfigurieren Sie Oracle Linux 8.10 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit Oracle Linux 8.10 verwenden, um ONTAP-LUNs zu verwalten.


NOTE: Sie können die link:hu_rhel_810.html#rhel-rhck["empfohlene Einstellungen für Red Hat Enterprise Linux (RHEL) 8.10"] um den Red Hat Compatible Kernel für Oracle Linux 8.10 zu konfigurieren.
