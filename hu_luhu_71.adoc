...
.Was Sie benötigen
Das NetApp Linux Unified Host Utilities-Softwarepaket ist auf der erhältlich link:https://mysupport.netapp.com/site/["NetApp Support Website"^] In einer 32-Bit- oder 64-Bit-.rpm-Datei.
...
. Laden Sie das Softwarepaket für 32 Bit oder 64 Bit Linux Unified Host Utilities von herunter link:https://mysupport.netapp.com/site/["NetApp Support Website"^] Auf Ihren Host.
