...
* Es gibt keine Unterstützung für NVMe-of für Sanlun. Daher wird für NVMe-of auf einem Oracle Linux 8.9 Host keine Host Utility-Unterstützung angeboten. Sie können das im nativen Paket enthaltene NetApp-Plug-in für alle NVMe-of-Übertragungen verwenden `nvme-cli`.
