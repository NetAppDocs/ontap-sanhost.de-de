...
+
Sie können das verwenden https://["NetApp Interoperabilitäts-Matrix-Tool"^] Um Ihre Konfiguration zu überprüfen.
...
Das Software-Paket NetApp AIX Host Utilities finden Sie auf der https://["NetApp Support Website"^] In einer komprimierten Datei von tar.gz.
