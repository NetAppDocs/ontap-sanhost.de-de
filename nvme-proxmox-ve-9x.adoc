...
[listing]
----
nqn.2014-08.org.nvmexpress:uuid:3933xxxx-3333-xxxx-4844-325xxxxa5247
----
...
[listing]
----
SN1700Q FW:v9.15.05 DVR:v10.02.10.100-k
SN1700Q FW:v9.15.05 DVR:v10.02.10.100-k
----
...
----
. Ändern Sie die Regel so, dass  `queue-depth` in  `round-robin` geändert wird, wie im folgenden Beispiel gezeigt:
+
[listing]
----
...
------------- ----------- -------------------- ------------------------ ---------- -------------------------- ---------------- --------
/dev/nvme2n1  /dev/ng2n1  81PqYFYq2aVAAAAAAAAB NetApp ONTAP Controller   0x1         17.88  GB / 171.80  GB      4 KiB +  0 B 9.19.1
----
====
...
----
 nvme-subsys3 - NQN=nqn.1992-08.com.netapp:sn.94929fdb84eb11f0b624d039eac809ba:subsystem.sub_176
                 hostnqn=nqn.2014-08.org.nvmexpress:uuid:3933xxxx-3333-xxxx-4844-325xxxxa524\
+- nvme1 *fc* traddr=nn-0x200dd039eac79573:pn-0x2360d039ea359e4a,host_traddr=nn-0x20000090fae0ec88:pn-0x10005ced8c531949 *live optimized*
+- nvme3 *fc* traddr=nn-0x200dd039eac79573:pn-0x200ed039eac79573,host_traddr=nn-0x20005ced8c531948:pn-0x10005ced8c531948 *live non-optimized*
...
+- nvme7 *fc* traddr=nn-0x200dd039eac7957a:pn-0x2011d039eac79573,host_traddr=nn-0x20005ced8c531948:pn-0x10005ced8c531948 *live non-optimized*
----
=====
