...
summary: NVMe/FC-Host-Konfiguration für Windows Server 2016 mit ONTAP 
---
= NVMe/FC-Host-Konfiguration für Windows Server 2016 mit ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
[role="lead"]
Sie können NVMe over Fibre Channel (NVMe/FC) auf Hosts konfigurieren, auf denen Windows Server 2016 ausgeführt wird, und dabei ONTAP als Ziel verwenden.

NVMe/FC wird auf ONTAP 9.7 oder höher für Windows Server 2016 unterstützt.
