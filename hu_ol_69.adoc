...
NOTE: Um Oracle Linux 6.9 Red hat Compatible Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_69.html#recommended-settings["Empfohlene Einstellungen"] für Red hat Enterprise Linux (RHEL) 6.9.
...
NOTE: Informationen zu bekannten Oracle Linux RHCK-Problemen finden Sie im link:hu_rhel_69.html#known-problems-and-limitations["Bekannte Probleme"] für RHEL 6.9.
