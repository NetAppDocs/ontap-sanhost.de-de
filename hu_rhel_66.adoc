...
| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=852674["1076584"^] | I/O-Stillstand bis zu 300 s bei QLogic 16G FC (QLE2672)-Host bei Speicherausfällen in RHEL 6U4 | Bei Storage-/Fabric-Ausfällen kann es vorkommen, dass ein I/O-Stillstand bis zu 300 Sekunden auf einem QLogic 16G FC (QLE2672)-Host beobachtet wird. 
