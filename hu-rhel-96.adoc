...
summary: Installieren Sie die Linux Host Utilities auf einem RHEL 9.6 Host, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu managen. 
---
= Konfigurieren Sie RHEL 9.6 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit RHEL 9.6 zum Verwalten von ONTAP-LUNs verwenden.
