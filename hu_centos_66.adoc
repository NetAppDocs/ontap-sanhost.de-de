...
For CentOS (Red Hat compatible kernel) known issues, see the link:hu_rhel_66.html#known-problems-and-limitations[known issues] for Red Hat Enterprise Linux (RHEL) 6.6.
----