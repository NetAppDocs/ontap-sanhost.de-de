...
NOTE: Um Oracle Linux 8.4 Red hat Compatible Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_84.html#recommended-settings["Empfohlene Einstellungen"] für Red hat Enterprise Linux (RHEL) 8.4.
...
NOTE: Informationen zu bekannten Oracle Linux RHCK-Problemen finden Sie im link:hu_rhel_84.html#known-problems-and-limitations["Bekannte Probleme"] Abschnitt in der entsprechenden RHEL-Versionsdokumentation.
