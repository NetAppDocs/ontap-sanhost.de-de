...
NOTE: To configure Oracle Linux 7.4 Red Hat Enterprise Kernel (RHCK), use the link:hu_rhel_74.html#recommended-settings[recommended settings] for Red Hat Enterprise Linux (RHEL) 7.4.
