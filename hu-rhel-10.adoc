---
sidebar: sidebar 
permalink: hu-rhel-10.html 
keywords: host utilities, red hat, rhel, linux, 10, netapp, ontap, rhel 
summary: Installieren Sie Linux Host Utilities auf einem RHEL 10-Host, um FCP- und iSCSI-Protokolloperationen mit ONTAP LUNs zu verwalten. 
---
= Konfigurieren Sie RHEL 10 für FCP und iSCSI mit ONTAP -Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Mit RHEL 10 können Sie Multipathing zur Verwaltung von ONTAP LUNs nutzen.
