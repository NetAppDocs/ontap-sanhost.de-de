...
---
= Verwendung von Veritas Infoscale 7 für Linux mit NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Dieses Dokument enthält Hinweise zur Konfiguration der ONTAP-SAN-Hosts für die Version der Veritas Infoscale Storage Foundation 7 Serie für Red hat Enterprise Linux & Oracle Linux (RHCK-basiert) Plattformen mit FC-, FCoE- und iSCSI-Protokollen.
