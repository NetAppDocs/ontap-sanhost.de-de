...
summary: Beschreibt die Verwendung von Oracle Linux 8.x mit ONTAP 
---
= Konfigurieren Sie Oracle Linux 8.x für FCP und iSCSI mit ONTAP -Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Mit Oracle Linux 8.x können Sie Multipathing zur Verwaltung von ONTAP LUNs nutzen.


NOTE: Sie können die link:hu-rhel-8x.html#rhel-rhck["Empfohlene Einstellungen für Red Hat Enterprise Linux (RHEL) 8.x"] Konfiguration eines Red Hat-kompatiblen Kernels für Oracle Linux 8.x.
