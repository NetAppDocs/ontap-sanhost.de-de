...
NOTE: Das NetApp Linux Unified Host Utilities Softwarepaket ist für das Ubuntu 24.04 Betriebssystem nicht verfügbar.
...
.Bevor Sie beginnen
Überprüfen Sie mithilfe deslink:https://mysupport.netapp.com/matrix/imt.jsp?components=91241;&solution=236&isHWU&src=IMT["NetApp Interoperabilitäts-Matrix-Tool"^], ob Betriebssystem, HBA, HBA-Firmware, HBA-Boot-BIOS und ONTAP-Version unterstützt werden.
