...
--
Der native Inbox qla2xxx Treiber, der im OL 9.1 GA Kernel enthalten ist, hat die neuesten Upstream-Fixes. Diese Fehlerbehebungen sind für die Unterstützung von ONTAP unerlässlich.
