...
[role="lead"]
NVMe over Fabrics (NVMe-of), einschließlich NVMe/FC- und anderer Übertragungen, wird mit Oracle Linux (OL) 9.1 mit Asymmetric Namespace Access (ANA) unterstützt. In NVMe-of Umgebungen entspricht ANA ALUA Multipathing in iSCSI- und FC-Umgebungen und wird mit in-Kernel NVMe Multipath implementiert.
...
Die NVMe-of-Hostkonfiguration für OL 9.1 mit ONTAP-Release weist folgende bekannte Probleme auf:
