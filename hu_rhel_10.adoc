...
summary: Installieren Sie die Linux Host Utilities auf einem RHEL 10 Host, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu managen. 
---
...
Sie können Multipathing mit RHEL 10 zum Verwalten von ONTAP-LUNs verwenden.
