...
summary: Installieren Sie die Linux Host Utilities auf einem RHEL 8.0 Host, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu managen. 
---
= Konfigurieren Sie RHEL 8.0 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit RHEL 8.0 zum Verwalten von ONTAP-LUNs verwenden.
...
Die RHEL 8.0 mit ONTAP-Speicherversion weist folgende bekannte Probleme auf:
