...
---
= NVMe-of Host-Konfiguration für RHEL 9.2 mit ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
--
.Schritte
. Der native Inbox qla2xxx Treiber, der im RHEL 9.2 GA Kernel enthalten ist, verfügt über die neuesten Upstream-Fixes, die für die Unterstützung von ONTAP unerlässlich sind. Vergewissern Sie sich, dass der unterstützte Adaptertreiber und die unterstützten Firmware-Versionen ausgeführt werden:
+
[listing]
----
