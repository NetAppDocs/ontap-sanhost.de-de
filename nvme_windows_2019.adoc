...
summary: NVMe/FC-Host-Konfiguration für Windows Server 2019 mit ONTAP 
---
...
[role="lead"]
Sie können NVMe over Fibre Channel (NVMe/FC) auf Hosts konfigurieren, auf denen Windows Server 2019 ausgeführt wird, und dabei ONTAP als Ziel verwenden.

NVMe/FC wird auf ONTAP 9.7 oder höher für Windows Server 2019 unterstützt.
