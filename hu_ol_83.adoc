...
NOTE: Um Oracle Linux 8.3 Red hat Enterprise Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_83.html#recommended-settings["Empfohlene Einstellungen"] für Red hat Enterprise Linux (RHEL) 8.3.
...
NOTE: Informationen zu bekannten Problemen bei Oracle Linux (Red hat Compatible Kernel) finden Sie im link:hu_rhel_83.html#known-problems-and-limitations["Bekannte Probleme"] Abschnitt in der entsprechenden Dokumentation zur Red hat Enterprise Linux-Version.
