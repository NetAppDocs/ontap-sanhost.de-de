...
In den folgenden Abschnitten finden Sie beispielhafte Multipath-Ausgaben für eine LUN, die Konfigurationen mit All-SAN-Arrays (ASA) und nicht-ASA zugeordnet ist.
