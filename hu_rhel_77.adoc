...
---
= Konfigurieren Sie RHEL 7.7 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit RHEL 7.7 zum Verwalten von ONTAP-LUNs verwenden.
...
Die RHEL 7.7 mit ONTAP-Speicherversion weist folgende bekannte Probleme auf:
