...
---
= Verwenden Sie Oracle Linux 6.7 mit ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Sie können die Konfigurationseinstellungen des ONTAP-SAN-Hosts verwenden, um Oracle Linux 6.7 mit ONTAP als Ziel zu konfigurieren.
...
NOTE: Um Oracle Linux 6.7 Red hat Enterprise Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_67.html#recommended-settings["Empfohlene Einstellungen"] für Red hat Enterprise Linux (RHEL) 6.7.



== Bekannte Probleme

Es gibt keine bekannten Probleme für die Oracle Linux 6.7 mit ONTAP-Version.
