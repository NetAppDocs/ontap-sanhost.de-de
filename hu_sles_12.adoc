...
---
= Verwenden Sie SUSE Linux Enterprise Server 12 mit ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
SUSE Linux Enterprise Server 12 OS wird kompiliert, um ONTAP-LUNs zu erkennen und automatisch alle Konfigurationsparameter richtig einzustellen.
...
Die SLES 12 mit ONTAP-Version weist folgende bekannte Probleme auf:
