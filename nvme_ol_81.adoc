...
* Es gibt keine Sanlun-Unterstützung für NVMe/FC und folglich auch keine Linux Host Utilities-Unterstützung für NVMe/FC unter Oracle Linux 8.1. Verwenden Sie die ONTAP-Befehlsausgabe als Teil des NetApp Plug-ins, das in der nativen nvme-cli enthalten ist.
