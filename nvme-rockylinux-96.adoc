...
.Schritte
. Installieren Sie Rocky Linux 9.6 auf dem Server. Überprüfen Sie nach Abschluss der Installation, ob Sie den angegebenen Rocky Linux 9.6-Kernel verwenden:
+
[source, cli]
----
uname -r
