...
[NOTE]
====
Nach der Installation von Windows Host Utilities 7.2 muss der Wert des Parameters LimTransferSize geändert werden. Siehe <<parameter-72,NVME-Parameter>>.
...
[[parameter-72]]Das Installationsprogramm der Windows Host Utilities legt die Windows-Registrierungswerte sowie die iSCSI- und NVMe-HBA-Parameter automatisch entsprechend der während der Installation getroffenen Auswahl fest. Diese Werte und die Version des Betriebssystems sollten überprüft werden.
...
* Der HBA-Anbieter
* Unabhängig davon, ob Sie MPIO Software verwenden
