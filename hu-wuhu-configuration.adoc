...
[NOTE]
====
Nach der Installation von Windows Host Utilities 7.2 muss der Wert des Parameters LimTransferSize geändert werden. Siehe <<nvme-parameter,NVME-Parameter>>.
...
[#nvme-parameter,role="tabbed-block"]
====
.Windows-Registrierungswerte
--
Alle Windows-Registrierungswerte sind, sofern nicht anders angegeben, dezimal.
