...
summary: Installieren Sie die Linux Host Utilities auf einem RHEL 9.2 Host, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu managen. 
---
= Konfigurieren Sie RHEL 9.2 für FCP und iSCSI mit ONTAP-Speicher
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sie können Multipathing mit RHEL 9.2 zum Verwalten von ONTAP-LUNs verwenden.
...
Das RHEL 9.2 mit ONTAP-Speicherversion weist das folgende bekannte Problem auf:
