---
sidebar: sidebar 
permalink: hu-ubuntu-2604.html 
keywords: host utilities, linux, ubuntu, 26.04, netapp, ontap, fcp, iscsi 
summary: Linux Host Utilities auf einem Ubuntu 26.04 Host installieren, um FCP und iSCSI Protokolloperationen mit ONTAP LUNs zu verwalten. 
---
= Ubuntu 26.04 für FCP und iSCSI mit ONTAP Speicher konfigurieren
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Die Linux Host Utilities Software bietet Verwaltungs- und Diagnosewerkzeuge für Linux-Hosts, die mit ONTAP Storage verbunden sind. Bei Installation der Linux Host Utilities auf einem Ubuntu 26.04 Host stehen Werkzeuge zur Verfügung, um FCP- und iSCSI-Protokollvorgänge mit ONTAP LUNs zu verwalten.
...
Multipathing kann unter Ubuntu 26.04 zur Verwaltung von ONTAP LUNs verwendet werden.
