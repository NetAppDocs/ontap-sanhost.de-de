...
[role="lead"]
Sie können die Beispielbefehlsreferenz für HP-UX Unified Host Utilities 6.0 verwenden, um die NetApp Storage-Konfiguration mit dem Host Utilities Tool vollständig zu validieren.
