...
NOTE: Um Oracle Linux 8.0 Red hat Compatible Kernel (RHCK) zu konfigurieren, verwenden Sie den link:hu_rhel_80.html#recommended-settings["Empfohlene Einstellungen"] für Red hat Enterprise Linux (RHEL) 8.0.
...
NOTE: Informationen zu bekannten Oracle Linux RHCK-Problemen finden Sie im link:hu_rhel_80.html#known-problems-and-limitations["Bekannte Probleme"] für RHEL 8.0.
