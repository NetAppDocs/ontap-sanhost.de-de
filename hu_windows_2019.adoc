...
[role="lead"]
Sie können die Konfigurationseinstellungen des ONTAP-SAN-Hosts verwenden, um Windows Server 2019 mit ONTAP als Ziel zu konfigurieren.
...
NOTE: Wenn Sie MPIO auswählen, aktiviert Windows Host Utilities die integrierte MPIO-Funktion von Windows Server 2019.
